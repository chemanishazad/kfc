...
class _HomePageState extends State<HomePage>
  ...
  final List<ProductModel> products = [
    ProductModel(
        name: "Vanilla Frappuccino", price: 24.80, image: "assets/icons/7.png"),
    ProductModel(
        name: "Caramel Frappuccino", price: 30.00, image: "assets/icons/2.png"),
    ProductModel(
        name: "Mocha Coconut Frappuccino",
        price: 45.50,
        image: "assets/icons/3.png"),
    ProductModel(
        name: "Matcha Green Tea", price: 15.75, image: "assets/icons/4.png"),
    ProductModel(
        name: "Caramelly Intense Frappuccino",
        price: 35.00,
        image: "assets/icons/5.png"),
    ProductModel(name: "Milkshake", price: 12.00, image: "assets/icons/6.png"),
    ProductModel(name: "Milkshake", price: 12.00, image: "assets/icons/8.png"),
    ProductModel(name: "Milkshake", price: 12.00, image: "assets/icons/9.png"),
    ProductModel(name: "Milkshake", price: 12.00, image: "assets/icons/10.png"),
  ];
